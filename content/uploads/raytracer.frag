...
// So, to recap, this was my first foray into ray tracing. Originally, I wanted
// to write this using the OpenGL Compute Shader. That was harder to setup than
// I originally anticipated, and I spent a fair bit of time mucking around with
// OpenGL and cmake before deciding to just sit down and start programming.
